    ...
    <div class="layout-width">
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <a href="/" class="logo">
                    <span class=""hamburger-icon"id="topnav-hamburger-icon">
                        <img src="<?php echo e(URL::asset('build/images/rma.png')); ?>" alt="" height="30">
                    </span>
                </a>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user ">
                    <button type="button" class="btn material-shadow-none" id="page-header-user-dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user"
                                src="<?php if(Auth::user()->avatar != ''): ?> https://vaneath.com/images/vaneath.png <?php endif; ?>"
                                alt="Header Avatar">
                            <span class="text-start ms-xl-2">
                                <span
                                    class="d-none d-xl-inline-block ms-1 fw-medium user-name-text"><?php echo e(Auth::user()->full_name); ?></span>
                                <span
                                    class="d-none d-xl-block ms-1 fs-12 user-name-sub-text"><?php echo e(Auth::user()->points); ?>
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="#"><i
                                ...
                                class="align-middle">Points : <b
                                    class="text-success"><?php echo e(Auth::user()->points); ?></b></span></a>
...
<?php /**PATH /home/vaneath/projects/rma-ideation/resources/views/layouts/topbar.blade.php ENDPATH**/ ?>