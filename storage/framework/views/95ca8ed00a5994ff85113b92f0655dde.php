            ...
            <div class="card mt-n5">
                <div class="card-body p-4">
                    <div class="text-center">
                        ...
                        <h5 class="fs-16 mb-1"><?php echo e(Auth::user()->full_name); ?></h5>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="firstnameInput" name="first_name"
                                                placeholder="Enter your firstname" value="<?php echo e(Auth::user()->first_name); ?>">
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="lastnameInput" name="last_name"
                                                placeholder="Enter your lastname" value="<?php echo e(Auth::user()->last_name); ?>">
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="genderInput" name="gender">
                                                <option value="" disabled
                                                    <?php echo e(is_null(Auth::user()->gender) ? 'selected' : ''); ?>>Please select your
                                                    gender</option>
                                                <option value="male"
                                                    <?php echo e(Auth::user()->gender == 'male' ? 'selected' : ''); ?>>Male</option>
                                                <option value="female"
                                                    <?php echo e(Auth::user()->gender == 'female' ? 'selected' : ''); ?>>Female</option>
                                                <option value="other"
                                                    <?php echo e(Auth::user()->gender == 'other' ? 'selected' : ''); ?>>Other</option>
                                            </select>
                                        </div>
                                    </div>
                                    <!--end col-->
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="jobTitleInput"
                                                ...
                                                value="<?php echo e(Auth::user()->job_title); ?>">
                                        </div>
                                    </div>
                                    <!--end col-->
                                </div>
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table id="buttons-datatables" class="display table table-bordered"
                                                    ...
                                                    <tbody>
                                                        <?php $__currentLoopData = Auth::user()->records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $records): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                <td><?php echo e($records->id); ?></td>
                                                                <td><?php echo e($records->district); ?></td>
                                                                <td><?php echo e($records->driving_purpose); ?></td>
                                                                <td><?php echo e($records->driving_frequency); ?></td>
                                                                <td><?php echo e($records->favorite_car_feature); ?></td>
                                                                <td><?php echo e($records->car_fuel); ?></td>
                                                                <td><?php echo e($records->car_type); ?></td>
                                                                <td><?php echo e($records->car_make); ?></td>
                                                                <td><?php echo e($records->car_model); ?></td>
                                                                <td><?php echo e($records->car_color); ?></td>
                                                                <td><?php echo e($records->car_year); ?></td>
                                                                <td>
                                                                    <?php if($records->review_status == 'Pending'): ?>
                                                                        <span class="badge bg-warning">Pending</span>
                                                                    <?php elseif($records->review_status == 'Approved'): ?>
                                                                        <span class="badge bg-success">Approved</span>
                                                                    <?php elseif($records->review_status == 'Rejected'): ?>
...
<?php echo $__env->make('layouts.rma', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vaneath/projects/rma-ideation/resources/views/pages-profile-settings.blade.php ENDPATH**/ ?>