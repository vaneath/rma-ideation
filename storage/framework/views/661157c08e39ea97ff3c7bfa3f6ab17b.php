            ...
            <div class="overflow-auto">
                <div class="d-flex gap-3">
                    ...
                    <div class="card col-xl-3 col-md-6" style="min-width: 15rem;">
                        ...
                        <img class="img-fluid mx-auto" src="<?php echo e(URL::asset('build/images/pizza.jpg')); ?>" width="100"
                            alt="Card image cap">
                        <div class="card-body">
                    ...
                    <div class="card col-xl-3 col-md-6" style="min-width: 15rem;">
                        ...
                        <img class="img-fluid d-block mx-auto" src="<?php echo e(URL::asset('build/images/small/img-4.jpg')); ?>"
                            alt="Card image cap">
                        <div class="card-body">
            ...
            <div class="overflow-auto">
                <div class="d-flex gap-3">
                    ...
                    <div class="card col-xl-3 col-md-6" style="min-width: 15rem">
                        ...
                        <img class="img-fluid d-block mx-auto" src="<?php echo e(URL::asset('build/images/total.png')); ?>"
...
<?php echo $__env->make('layouts.rma', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vaneath/projects/rma-ideation/resources/views/dashboard-wallets.blade.php ENDPATH**/ ?>